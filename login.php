...
if(isset($_POST['email']) && isset($_POST['password'])) {
  ...
  if ($_POST['email']==""){
    ...
    $conn = mysqli_connect("localhost","admin_jonsuiot","ellalabotella","admin_jonsuiot");
    ...
    <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
      ...
      <form target "" method="post" name="form">
        <div class="md-form-group float-label">
          <input name="email" type="email" class="md-input" value="<?php echo $email ?>" ngd-model="user.email" required>
          <label>Email</label>
        </div>
        <div class="md-form-group float-label">
...
<!-- core -->
  ...
  <script src="https://cdn.jsdelivr.net/npm/mqtt@4.2.1/dist/mqtt.min.js"></script>
...
/*
  ...
  const WebSocket_URL = 'wss://jonsuiot.ga:8094/mqtt'
